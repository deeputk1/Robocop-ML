...
#sys.path.append(os.path.join("/u/animesh9/Documents/New_RoboCup_Rescue_Simulator/PyRCRSClient/RCRS_gRPC_Client"))
...
def greedy_actions(listt, N):
    ...
    for i in range(0,N):
        ...
        final_list_index.append(listt.index(max1))
        listt.remove(max1)
        
    final_list_index = [round(h) for h in final_list_index]
